...
func main() {
	c, err := client.NewStdioMCPClient(
		...
		"C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go",
	)
	if err != nil {
	...
	// List C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp
	fmt.Println("Listing C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp directory...")
	...
	listTmpRequest.Params.Arguments = map[string]any{
		"path": "C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp",
	}
	...
	fmt.Println("Creating C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp/mcp directory...")
	...
	createDirRequest.Params.Arguments = map[string]any{
		"path": "C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp/mcp",
	}
	...
	// Create hello.txt
	fmt.Println("Creating C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp/mcp/hello.txt...")
	...
	writeFileRequest.Params.Arguments = map[string]any{
		"path":    "C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp/mcp/hello.txt",
		"content": "Hello World",
	}
	...
	fmt.Println("Reading C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp/mcp/hello.txt...")
	...
	// Get file info
	fmt.Println("Getting info for C:\\Users\\wyz\\Desktop\\go-try\\practice-go\\agent-go\\tmp/mcp/hello.txt...")
